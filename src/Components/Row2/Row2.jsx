    ...
    */
    ...
    return (
        ...
        <div class="main-boxes-container">    
          <div class="main-box">
            <h4 class="heading-4">Total Stakers</h4>
            <h6 class="heading-6">{totalmoneystakers}</h6>
          </div>
        
          <div className="main-box">
            <h4 class="heading-4">Total Staked</h4>
            <h6 class="heading-6">{totalMoneyStaked}</h6>
          </div>


          <div className="main-box">
            <h4 class="heading-4">Total Supply</h4>
            <h6 class="heading-6">{totalSupply}</h6>
          </div>
        </div>
        </>
    )
